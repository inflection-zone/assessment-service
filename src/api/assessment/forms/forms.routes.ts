...
import { FormsController } from '../../assessment/forms/forms.controller';
...
export const register = (app: express.Application): void => {
    ...
    router.post('/provider/:providerCode/connect', authenticator.authenticateClient, controller.connect);

    //Get list of forms for the user with an account with given provider
    router.get('/provider/:providerCode/forms', authenticator.authenticateClient, controller.getFormsList);
    ...
    router.post('/provider/:providerCode/import-form/:providerFormId',
        authenticator.authenticateClient, controller.importFormAsAssessmentTemplate);
