...
import { CAssessmentListNode, CAssessmentMessageNode, CAssessmentNode, CAssessmentQuestionNode, CAssessmentTemplate, CScoringCondition } from '../../../domain.types/assessment/assessment.types';
import { uuid } from '../../../domain.types/miscellaneous/system.types';
import { AssessmentTemplateFileConverter } from '../../../services/assessment/assessment.template.file.converter';
import { AssessmentTemplateService } from '../../../services/assessment/assessment.template.service';
...
export class AssessmentTemplateController extends BaseController{
    ...
    create = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('AssessmentTemplate.Create', request);
    ...
    getById = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('AssessmentTemplate.GetById', request);
    ...
    search = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('AssessmentTemplate.Search', request);
    ...
    update = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('AssessmentTemplate.Update', request);
    ...
    delete = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('AssessmentTemplate.Delete', request);
    ...
    export = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('AssessmentTemplate.Export', request);
            const id: uuid = await this._validator.getParamUuid(request, 'id');
    ...
    importFromFile = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('AssessmentTemplate.ImportFromFile', request);
    ...
    importFromJson = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('AssessmentTemplate.ImportFromJson', request);
    ...
    addNode = async (request: express.Request, response: express.Response) => {
        try {
            ...
            await this.setContext('AssessmentTemplate.AddNode', request);
    ...
    updateNode = async (request: express.Request, response: express.Response) => {
        try {
            ...
            await this.setContext('AssessmentTemplate.UpdateNode', request);
    ...
    deleteNode = async (request: express.Request, response: express.Response) => {
        try {
            ...
            await this.setContext('AssessmentTemplate.DeleteNode', request);
    ...
    getNode = async (request: express.Request, response: express.Response) => {
        try {
            ...
            await this.setContext('AssessmentTemplate.GetNode', request);
    ...
    addScoringCondition = async (request: express.Request, response: express.Response) => {
        try {
            ...
            await this.setContext('AssessmentTemplate.AddScoringCondition', request);
    ...
    updateScoringCondition = async (request: express.Request, response: express.Response) => {
        try {
            ...
            await this.setContext('AssessmentTemplate.UpdateScoringCondition', request);
    ...
    deleteScoringCondition = async (request: express.Request, response: express.Response) => {
        try {
            ...
            await this.setContext('AssessmentTemplate.DeleteScoringCondition', request);
    ...
    getScoringCondition = async (request: express.Request, response: express.Response) => {
        try {
            ...
            await this.setContext('AssessmentTemplate.GetScoringCondition', request);
