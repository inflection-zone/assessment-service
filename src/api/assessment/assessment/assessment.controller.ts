...
import { AssessmentNodeType, CAssessmentListNode } from '../../../domain.types/assessment/assessment.types';
import { AssessmentHelperRepo } from '../../../database/sql/sequelize/repositories/assessment/assessment.helper.repo';
...
export class AssessmentController extends BaseController{
    ...
    create = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('Assessment.Create', request);
    ...
    getById = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('Assessment.GetById', request);
    ...
    search = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('Assessment.Search', request);
    ...
    update = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('Assessment.Update', request);
    ...
    delete = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('Assessment.Delete', request);
    ...
    startAssessment = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('Assessment.StartAssessment', request);
    ...
    getNextQuestion = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('Assessment.GetNextQuestion', request);
    ...
    getQuestionById = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('Assessment.GetQuestionById', request);
    ...
    answerQuestion = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('Assessment.AnswerQuestion', request);
    ...
    answerQuestionList = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            await this.setContext('Assessment.AnswerQuestionList', request);
