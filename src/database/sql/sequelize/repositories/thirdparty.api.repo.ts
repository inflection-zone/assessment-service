import { IThirdpartyApiRepo } from '../../../repository.interfaces/thirdparty.api.repo.interface';
...
import { ThirdpartyApiCredentialsMapper } from '../mappers/thirdparty.api.credentials.mapper';
